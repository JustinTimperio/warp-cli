...
parser.add_argument(
    ...
    "--ship",
    nargs=4,
    metavar=("SRC_SSH_ALIAS", "SRC_PATH", "RECV_SSH_ALIAS", "RECV_PATH"),
...
parser.add_argument(
    ...
    "--push",
    nargs=3,
    metavar=("SRC_PATH", "RECV_SSH_ALIAS", "RECV_PATH"),
...
parser.add_argument(
    ...
    "--fetch",
    nargs=3,
    metavar=("SRC_SSH_ALIAS", "SRC_PATH", "RECV_PATH"),
